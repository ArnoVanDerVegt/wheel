...
exports.Brick = class {
    ...
    initModules() {
        ...
        modules[ 0] = new StandardModule({brick: this});
        modules[ 1] = new MathModule    ({brick: this});
        modules[ 2] = new ScreenModule  ({brick: this});
        modules[ 3] = new LightModule   ({brick: this});
        modules[ 4] = new ButtonModule  ({brick: this});
        modules[ 5] = new SoundModule   ({brick: this});
        modules[ 6] = new MotorModule   ({brick: this});
        modules[ 7] = new SensorModule  ({brick: this});
        modules[ 8] = new FileModule    ({brick: this});
        modules[ 9] = new SystemModule  ({brick: this});
        modules[10] = new StringModule  ({brick: this});
        modules[11] = new BitModule     ({brick: this});
    }
    ...
    getStatus() {
        let commandQueue = this._commandQueue;
        let motorModule  = this._modules[6];
