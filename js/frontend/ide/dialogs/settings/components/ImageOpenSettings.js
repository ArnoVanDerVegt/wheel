            ...
            children: [
                {
                    ...
                    children: [
                        ...
                        },
                        {
                            ...
                            value:    this._settings[opts.getter](),
                            onChange: dispatcher.dispatch.bind(dispatcher, opts.signal),
                            options: [
                ...
                children: [
                    {
                        type:      'h3',
                        className: 'image-setting-row',
                        innerHTML: 'Image open options'
                    },
                    {
                        className: 'image-setting-row description',
                        innerHTML: 'Image files can be converted to <i>.rgf</i> files for the EV3 or they can be viewed.<br/>' +
