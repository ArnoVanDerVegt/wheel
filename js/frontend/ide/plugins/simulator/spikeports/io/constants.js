...
let deviceInfo = [];
deviceInfo[spikeModuleConstants.SPIKE_DEVICE_SMALL_MOTOR   ] = {src: 'images/spike/motorMedium64.png', motor: true,  value: true};
...
deviceInfo[sensorModuleConstants.SENSOR_TYPE_SPIKE_LIGHT   ] = {src: 'images/poweredup/light64.png',   motor: false, value: false};
