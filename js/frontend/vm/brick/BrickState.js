...
exports.BrickState = class extends Emitter {
    constructor(opts) {
        ...
        this._layerState = [
            ...
            new LayerState({layer: 2, brick: this}),
            new LayerState({layer: 3, brick: this})
        ];
        dispatcher
            .on('Brick.ConnectToDevice', this, this.onConnectToDevice)
            .on('Brick.LayerCount',      this, this.onLayerCount);
    }
    ...
    setStatus(status) {
        if (status.battery !== this._battery) {
            ...
            this.emit('Brick.Battery', status.battery);
        }
    }
    ...
    onConnectToDevice(deviceName) {
        ...
        this.emit('Brick.Connecting', deviceName);
