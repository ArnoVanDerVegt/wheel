...
const POWERED_UP_STATE_ACCEL_OFFSET = 1 + 3;
...
exports.PoweredUpModule = class extends LocalPoweredUpModule {
    ...
    subscribe(device) {
        ...
        for (let i = 0; i < poweredUpModuleConstants.POWERED_UP_LAYER_COUNT; i ++) {
            this
                .subscribeToVectorChange(device, 'PoweredUp.Layer' + i + '.Tilt',  i, POWERED_UP_STATE_TILT_OFFSET)
                .subscribeToVectorChange(device, 'PoweredUp.Layer' + i + '.Accel', i, POWERED_UP_STATE_ACCEL_OFFSET);
