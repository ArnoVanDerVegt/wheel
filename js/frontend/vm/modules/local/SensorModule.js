    ...
    run(commandId) {
        ...
        switch (commandId) {
            case sensorModuleConstants.SENSOR_SET_TYPE:
                this.emit('Sensor.SetType', vmData.getRecordFromSrcOffset(['layer', 'id', 'type']));
                break;
            ...
            case sensorModuleConstants.SENSOR_SET_MODE:
                this.emit('Sensor.SetMode', vmData.getRecordFromSrcOffset(['layer', 'id', 'mode']));
                break;
            case sensorModuleConstants.SENSOR_RESET:
                this.emit('Sensor.Reset', vmData.getRecordFromSrcOffset(['layer', 'id']));
                break;
