...
(function() {
    CodeMirror.defineMode(
        ...
        function() {
            ...
            let meta     = words('#format #noformat #define #include #image #heap #datatype #optimizer #rangecheck #data #project #break #display #resource #text #line #stringlength #stringcount #alias');
