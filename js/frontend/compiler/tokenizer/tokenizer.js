...
(function() {
    ...
    const LEXEME_META_PROJECT       = '#project';
    const LEXEME_META_INCLUDE       = '#include';
    const LEXEME_META_DEFINE        = '#define';
    const LEXEME_META_IMAGE         = '#image';
    const LEXEME_META_TEXT          = '#text';
    const LEXEME_META_RESOURCE      = '#resource';
    const LEXEME_META_DATA          = '#data';
    const LEXEME_META_LINE          = '#line';
    const LEXEME_META_FORMAT        = '#format';
    const LEXEME_META_NOFORMAT      = '#noformat';
    const LEXEME_META_DISPLAY       = '#display';
    const LEXEME_META_HEAP          = '#heap';
    const LEXEME_META_OPTIMIZER     = '#optimizer';
    const LEXEME_META_RANGECHECK    = '#rangecheck';
    const LEXEME_META_DATATYPE      = '#datatype';
    const LEXEME_META_STRINGLENGTH  = '#stringlength';
    ...
    exports.LEXEME_META_PROJECT       = LEXEME_META_PROJECT;
    exports.LEXEME_META_INCLUDE       = LEXEME_META_INCLUDE;
    exports.LEXEME_META_DEFINE        = LEXEME_META_DEFINE;
    exports.LEXEME_META_IMAGE         = LEXEME_META_IMAGE;
    exports.LEXEME_META_TEXT          = LEXEME_META_TEXT;
    exports.LEXEME_META_RESOURCE      = LEXEME_META_RESOURCE;
    exports.LEXEME_META_DATA          = LEXEME_META_DATA;
    exports.LEXEME_META_LINE          = LEXEME_META_LINE;
    exports.LEXEME_META_FORMAT        = LEXEME_META_FORMAT;
    exports.LEXEME_META_NOFORMAT      = LEXEME_META_NOFORMAT;
    exports.LEXEME_META_DISPLAY       = LEXEME_META_DISPLAY;
    exports.LEXEME_META_HEAP          = LEXEME_META_HEAP;
    exports.LEXEME_META_OPTIMIZER     = LEXEME_META_OPTIMIZER;
    exports.LEXEME_META_RANGECHECK    = LEXEME_META_RANGECHECK;
    exports.LEXEME_META_DATATYPE      = LEXEME_META_DATATYPE;
    exports.LEXEME_META_STRINGLENGTH  = LEXEME_META_STRINGLENGTH;
