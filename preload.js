...
require('./js/shared/vm/modules/components/componentTextInputModuleConstants');
require('./js/shared/vm/modules/components/componentSliderModuleConstants');
...
require('./js/frontend/vm/modules/local/components/ComponentTextInputModule');
require('./js/frontend/vm/modules/local/components/ComponentSliderModule');
...
require('./js/frontend/lib/components/TextArea');
...
require('./js/frontend/ide/dialogs/settings/components/BooleanSetting');
require('./js/frontend/ide/dialogs/settings/components/IncludeFilesSetting');
...
require('./js/frontend/ide/settings/IncludeFilesState');
require('./js/frontend/vm/BasicDeviceState');
require('./js/frontend/ide/IDEAssistant');
