...
require('./js/frontend/ide/editor/editors/form/ComponentList');
...
require('./js/frontend/ide/properties/types/StringListProperty');
require('./js/frontend/ide/properties/types/IntegerProperty');
