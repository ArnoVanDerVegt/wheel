...
require('./js/frontend/vm/modules/local/components/ComponentIntervalSensorModule');
require('./js/frontend/vm/modules/local/components/ComponentTimeoutSensorModule');
