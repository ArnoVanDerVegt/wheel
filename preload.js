...
require('./js/shared/vm/modules/components/componentIconModuleConstants');
...
require('./js/shared/vm/modules/components/componentAlertDialogModuleConstants');
require('./js/shared/vm/modules/components/componentConfirmDialogModuleConstants');
require('./js/shared/vm/modules/components/componentIntervalModuleConstants');
require('./js/shared/vm/modules/components/componentTimeoutModuleConstants');
...
require('./js/frontend/compiler/types/Objct');
...
require('./js/frontend/compiler/keyword/CompileSuper');
...
require('./js/frontend/vm/modules/local/components/ComponentIconModule');
...
require('./js/frontend/vm/modules/local/components/ComponentIntervalModule');
require('./js/frontend/vm/modules/local/components/ComponentTimeoutModule');
require('./js/frontend/vm/modules/local/components/ComponentAlertDialogModule');
require('./js/frontend/vm/modules/local/components/ComponentConfirmDialogModule');
...
require('./js/frontend/lib/components/component/componentStyle');
require('./js/frontend/lib/components/component/Component');
require('./js/frontend/lib/components/component/ComponentContainer');
...
require('./js/frontend/lib/components/WizardSteps');
require('./js/frontend/lib/components/IncludeFiles');
require('./js/frontend/lib/components/mainmenu/MainMenuItem');
require('./js/frontend/lib/components/mainmenu/MainMenu');
require('./js/frontend/lib/components/input/IconSelect');
require('./js/frontend/lib/components/input/Tabs');
require('./js/frontend/lib/components/input/Button');
require('./js/frontend/lib/components/input/Dropdown');
require('./js/frontend/lib/components/input/CloseButton');
require('./js/frontend/lib/components/input/TextArea');
require('./js/frontend/lib/components/input/TextInput');
require('./js/frontend/lib/components/input/Checkbox');
require('./js/frontend/lib/components/input/Radio');
require('./js/frontend/lib/components/input/Slider');
require('./js/frontend/lib/components/input/ToolOptions');
require('./js/frontend/lib/components/status/LoadingDots');
require('./js/frontend/lib/components/status/ProgressBar');
require('./js/frontend/lib/components/status/StatusLight');
require('./js/frontend/lib/components/text/Title');
require('./js/frontend/lib/components/text/Text');
require('./js/frontend/lib/components/text/ListItems');
require('./js/frontend/lib/components/text/Label');
...
require('./js/frontend/lib/components/nonvisual/AlertDialog');
require('./js/frontend/lib/components/nonvisual/ConfirmDialog');
...
require('./js/frontend/lib/components/graphics/Rectangle');
require('./js/frontend/lib/components/graphics/Circle');
require('./js/frontend/lib/components/graphics/Image');
require('./js/frontend/lib/components/graphics/Icon');
...
require('./js/frontend/ide/dialogs/settings/components/CheckboxSetting');
require('./js/frontend/ide/dialogs/settings/components/IncludeFilesSetting');
require('./js/frontend/ide/dialogs/settings/components/ImageOpenSettings');
require('./js/frontend/ide/dialogs/settings/components/TextInputSetting');
require('./js/frontend/ide/dialogs/settings/components/TextAreaSetting');
require('./js/frontend/ide/dialogs/settings/tabs/addVersionTab');
require('./js/frontend/ide/dialogs/settings/tabs/addExportTab');
require('./js/frontend/ide/dialogs/settings/tabs/addEditorTab');
require('./js/frontend/ide/dialogs/settings/tabs/addCompilerTab');
require('./js/frontend/ide/dialogs/settings/tabs/addViewTab');
require('./js/frontend/ide/dialogs/settings/tabs/addConsoleTab');
require('./js/frontend/ide/dialogs/settings/tabs/addSimulatorTab');
...
require('./js/frontend/ide/dialogs/list/components/AutoConnectListItem');
...
require('./js/frontend/ide/dialogs/list/PoweredUpAutoConnectListDialog');
require('./js/frontend/ide/dialogs/statistics/StatisticsDialog');
require('./js/frontend/ide/dialogs/YesNoCancelDialog');
require('./js/frontend/ide/dialogs/file/state/DeviceListState');
require('./js/frontend/ide/dialogs/file/components/Step');
require('./js/frontend/ide/dialogs/file/components/PoweredUpDeviceItem');
require('./js/frontend/ide/dialogs/file/components/PoweredUpDeviceList');
require('./js/frontend/ide/dialogs/file/components/PoweredUpStep1Start');
require('./js/frontend/ide/dialogs/file/components/PoweredUpStep2Device');
require('./js/frontend/ide/dialogs/file/components/PoweredUpStep3Ports');
require('./js/frontend/ide/dialogs/file/components/PoweredUpStep4Include');
require('./js/frontend/ide/dialogs/file/components/PoweredUpStep5Form');
require('./js/frontend/ide/dialogs/file/components/PoweredUpStep6Finish');
require('./js/frontend/ide/dialogs/file/FileDialog');
require('./js/frontend/ide/dialogs/file/FileOpenDialog');
require('./js/frontend/ide/dialogs/file/FileNewDialog');
require('./js/frontend/ide/dialogs/file/FileRenameDialog');
require('./js/frontend/ide/dialogs/file/FilePoweredUpProjectDialog');
...
require('./js/frontend/ide/dialogs/find/FindDialog');
require('./js/frontend/ide/dialogs/find/FindInFilesDialog');
require('./js/frontend/ide/dialogs/find/ReplaceDialog');
...
require('./js/frontend/ide/dialogs/tools/components/GearSettings');
...
require('./js/frontend/ide/source/sourceBuilderUtils');
require('./js/frontend/ide/source/SourceBuilder');
require('./js/frontend/ide/source/SourceFormatter');
...
require('./js/frontend/ide/editor/editors/form/state/FormEditorToolbarState');
require('./js/frontend/ide/editor/editors/form/state/FormEditorState');
require('./js/frontend/ide/editor/editors/form/FormEditor');
require('./js/frontend/ide/editor/editors/imageviewer/toolbar/ToolbarTop');
require('./js/frontend/ide/editor/editors/imageviewer/toolbar/ToolbarBottom');
require('./js/frontend/ide/editor/editors/imageviewer/ImageViewer');
...
require('./js/frontend/ide/properties/components/Container');
require('./js/frontend/ide/properties/components/Form');
require('./js/frontend/ide/properties/components/Property');
require('./js/frontend/ide/properties/components/Properties');
require('./js/frontend/ide/properties/components/Event');
require('./js/frontend/ide/properties/components/Events');
require('./js/frontend/ide/properties/components/types/BooleanProperty');
require('./js/frontend/ide/properties/components/types/DropdownProperty');
require('./js/frontend/ide/properties/components/types/HAlignProperty');
require('./js/frontend/ide/properties/components/types/ColorProperty');
require('./js/frontend/ide/properties/components/types/TextProperty');
require('./js/frontend/ide/properties/components/types/TextAreaProperty');
require('./js/frontend/ide/properties/components/types/TextListProperty');
require('./js/frontend/ide/properties/components/types/RgbProperty');
require('./js/frontend/ide/properties/components/types/IconProperty');
require('./js/frontend/ide/properties/components/Components');
...
require('./js/frontend/ide/IDEEvents');
require('./js/frontend/ide/IDEDialogs');
require('./js/frontend/ide/IDEDOM');
require('./js/frontend/ide/settings/PluginsState');
require('./js/frontend/ide/settings/IncludeFilesState');
require('./js/frontend/ide/settings/PoweredUpAutoConnectState');
