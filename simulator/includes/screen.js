wheel(
    ...
    [
        ...
        '#define SCREEN_DRAW_PIXEL  3',
        '#define SCREEN_DRAW_NUMBER 4',
        '#define SCREEN_DRAW_TEXT   5',
        '#define SCREEN_DRAW_LINE   6',
        '#define SCREEN_DRAW_RECT   7',
        '#define SCREEN_DRAW_CIRCLE 8',
        '#define SCREEN_DRAW_IMAGE  9',
        '',
        '#define WHITE              0',
        '#define BLACK              1',
        '',
