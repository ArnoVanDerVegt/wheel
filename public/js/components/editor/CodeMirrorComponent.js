    ...
    wheel(
        ...
        React.createClass({
            ...
            getActiveWheelGrammar: function() {
                ...
                var structList   = compilerData.getStructList();
                var labelList    = compilerData.getLabelList();
                var lex          = wheelGrammar['Lex'];
                var tokens;
            ...
            onMouseMove: function(event) {
                ...
                var compilerData     = this.props.compiler.getCompilerData();
                var x                 = event.pageX - this.state.left + 8;
                var y                 = event.pageY - 80;
                var className         = target.className.trim();
                var innerHTML         = target.innerHTML.trim();
                var codeHint         = this.refs.codeHint;
                var info             = null;
