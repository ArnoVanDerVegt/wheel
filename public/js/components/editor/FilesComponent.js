(function() {
    ...
    wheel(
        'components.editor.FilesComponent',
        React.createClass({
            getInitialState: function() {
            ...
            render: function() {
                ...
                var activeFile = props.files.getFile(props.activeFileIndex);
                var activePath = activeFile ? activeFile.getName() : '';
                var addPath    = function(path, dir, changed, active) {
                        if (path[0] === '/') {
