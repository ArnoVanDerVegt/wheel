...
require('../js/compiler/script/BooleanNode.js');
require('../js/compiler/script/BooleanOrNode.js');
require('../js/compiler/script/BooleanAndNode.js');
require('../js/compiler/script/BooleanOrValueNode.js');
require('../js/compiler/script/BooleanAndValueNode.js');
require('../js/compiler/script/BooleanRootNode.js');
